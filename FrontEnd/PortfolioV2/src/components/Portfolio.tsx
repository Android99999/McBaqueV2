  ...
  return (
    ...
    <div className='bg-[#DDCFC5] h-fit w-full flex flex-col justify-center items-center'>
      ...
      <div id="about" className='bg-[#DDCFC5] h-fit w-full flex flex-col justify-start items-center'>
          ...
          {/* 3rd */}
            <div className=' h-fit w-full flex 2xl:flex-row xl:flex-row justify-between gap-4 py-10 lg:flex-col sm:flex-col md:flex-col flex-col'>
              ...
              <div className='min-w-[30%] flex flex-col'>
                <div className='flex flex-col h-[50%] justify-center items-center xl:justify-start xl:items-start 2xl:justify-start 2xl:items-start '>
                  <div className='h-[60%] '><BiEditAlt size={75}  color='#3F3F46'/></div>
                  <div className='h-[50%] py-4 text-[2em] font-Poppins font-semibold tracking-widest text-[#7C2629] '>What I Do</div>
                </div>
                <div className='min-w-[100%] h-[50%] font-Poppins font-thin text-[1.4em] tracking-[0.15em] py-4 lg:text-center md:text-center sm:text-center'>
              ...
              <div className='min-w-[30%] flex flex-col'>
                ...
                <div className='max-w-[100%] h-[50%] font-Poppins font-thin text-[1.4em] tracking-[0.14em] py-4 lg:text-center md:text-center sm:text-center'>
